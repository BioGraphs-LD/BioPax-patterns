...
import static dyliss.biopax.pattern.ConBox.compToER;
import static dyliss.biopax.pattern.ConBox.controlToConv;
import static dyliss.biopax.pattern.ConBox.controlToInter;
import static dyliss.biopax.pattern.ConBox.controlToTempReac;
import static dyliss.biopax.pattern.ConBox.controllerPE;
import static dyliss.biopax.pattern.ConBox.convToControl;
import static dyliss.biopax.pattern.ConBox.differentialActivity;
import static dyliss.biopax.pattern.ConBox.equal;
import static dyliss.biopax.pattern.ConBox.erToPE;
import static dyliss.biopax.pattern.ConBox.hasDifferentCompartments;
import static dyliss.biopax.pattern.ConBox.interToPE;
import static dyliss.biopax.pattern.ConBox.isBait;
import static dyliss.biopax.pattern.ConBox.isPrey;
import static dyliss.biopax.pattern.ConBox.left;
...
import static dyliss.biopax.pattern.ConBox.participant;
import static dyliss.biopax.pattern.ConBox.participantER;
import static dyliss.biopax.pattern.ConBox.participatesInConv;
import static dyliss.biopax.pattern.ConBox.peToControl;
import static dyliss.biopax.pattern.ConBox.peToER;
import static dyliss.biopax.pattern.ConBox.peToInter;
import static dyliss.biopax.pattern.ConBox.product;
import static dyliss.biopax.pattern.ConBox.right;
import static dyliss.biopax.pattern.ConBox.simplePEToConv;
...
//		p.add(nextInteraction(), "upper Conversion", "Conversion");
	...
	public static Pattern controlsPhosphorylation()
	{
		...
		p.add(new ModificationChangeConstraint(ModificationChangeConstraint.Type.ANY,"phospho"), "input simple PE", "output simple PE");
		return p;
	}
